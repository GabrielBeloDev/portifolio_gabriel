  ...
  return (
    <div className="grid min-h-full lg:grid-cols-[1.5fr_0.95fr]">
      <section className="px-6 py-10 sm:px-10 lg:border-r lg:border-line-2 lg:p-14">
        <FadeUp delay={0} className="mb-[30px]">
          <TerminalPrompt />
        </FadeUp>
        <FadeUp delay={0.1} className="mb-[22px]">
        ...
        <FadeUp delay={0.18} className="mb-[34px]">
        ...
        <FadeUp delay={0.26} className="mb-12">
          <HeroCtas />
        </FadeUp>
        <FadeUp delay={0.34} className="mb-1">
      ...
      <aside className="flex flex-col gap-6 border-t border-line-2 px-6 py-10 sm:px-10 lg:border-t-0 lg:px-11 lg:py-14">
        ...
        <FadeUp delay={0.42}>
          <p className="mb-2 font-mono text-xs tracking-[0.1em] text-muted-2">
            // me acha em
          </p>
          <SocialLinks />
        </FadeUp>
